...
{
    public static BsonRegularExpression ToBsonRegularExpression<T>(this GroupMatcher<T> matcher)
        where T : Key<T>
    {
        ...
        throw new ArgumentOutOfRangeException(
            "Don't know how to translate " + matcher.CompareWithOperator + " into BSON regular expression"
        );
    }
}

...
public class StdAdoConstants : AdoConstants
{
    ...
    public static readonly string SqlDeleteAllSimpleTriggers =
        $"DELETE FROM {TablePrefixSubst}{TableSimpleTriggers} WHERE {ColumnSchedulerName} = @schedulerName";

    public static readonly string SqlDeleteAllSimpropTriggers =
        $"DELETE FROM {TablePrefixSubst}SIMPROP_TRIGGERS WHERE {ColumnSchedulerName} = @schedulerName";

    public static readonly string SqlDeleteAllCronTriggers =
        $"DELETE FROM {TablePrefixSubst}{TableCronTriggers} WHERE {ColumnSchedulerName} = @schedulerName";

    public static readonly string SqlDeleteAllBlobTriggers =
        $"DELETE FROM {TablePrefixSubst}{TableBlobTriggers} WHERE {ColumnSchedulerName} = @schedulerName";

    public static readonly string SqlDeleteAllTriggers =
        $"DELETE FROM {TablePrefixSubst}{TableTriggers} WHERE {ColumnSchedulerName} = @schedulerName";

    public static readonly string SqlDeleteAllJobDetails =
        $"DELETE FROM {TablePrefixSubst}{TableJobDetails} WHERE {ColumnSchedulerName} = @schedulerName";

    public static readonly string SqlDeleteAllCalendars =
        $"DELETE FROM {TablePrefixSubst}{TableCalendars} WHERE {ColumnSchedulerName} = @schedulerName";

    public static readonly string SqlDeleteAllPausedTriggerGrps =
        $"DELETE FROM {TablePrefixSubst}{TablePausedTriggers} WHERE {ColumnSchedulerName} = @schedulerName";
    ...
    public static readonly string SqlSelectNextTriggerToAcquire = $@"SELECT
    ...
    public static readonly string SqlSelectTrigger = $@"SELECT 
                {ColumnJobName},
                {ColumnJobGroup},
                {ColumnDescription},
                {ColumnNextFireTime},
